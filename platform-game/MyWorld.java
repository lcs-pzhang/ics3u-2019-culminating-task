...
public class MyWorld extends World
{
    ...
    private int[] delay = {2, 4, 6, 8, 10, 11, 13, 14, 16,
            ...
            43, 44, 44, 45, 47, 49, 50, 50, 52, 54, 55,
            57, 59, 61, 63, 64, 66, 67, 69, 70, 71, 73,
            73, 75, 75, 77, 79, 80, 80, 81, 81,
            83, 85, 85, 87, 88, 90, 91, 92, 94, 95, 97, 100, 100, 102, 102, 104};
    ...
    private int[] xPosition = {495, 491, 487, 483, 460, 460,100,
            ...
            247, 244, 241, 239, 115, 120, 121, 125, 127, 100,
            95, 92, 87, 85, 79, 84, 69, 73, 75, 77, 300,
            305, 307, 309, 330, 333, 336, 339, 350, 355, 357, 385, 383, 395, 397,  
            417, 440, 441, 444};
    ...
    private int[] yPosition = {350, 350, 350, 350, 330, 325, 150,
            ...
            243, 248, 250, 50, 52, 54, 55, 57, 67, 69,
            71, 73, 75, 77, 52, 54, 68, 80, 83, 85, 90, 60, 65, 93, 300, 314, 317,
            325, 335};
